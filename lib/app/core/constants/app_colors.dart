...
class AppColor {
  ...
  //--> App Color's
  static HexColor primaryLigth = HexColor('#303D4F');
  static HexColor primary = HexColor('#090E17');
  static HexColor secondary = HexColor('#4AB9FF');
  static HexColor secondaryDark = HexColor('#0084F3');
