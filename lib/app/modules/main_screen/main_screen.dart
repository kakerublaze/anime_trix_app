                          ...
                          icon: controller.selectedIndex.value == 0
                              ? Container(
                                  ...
                                  child: const ImageHelper(
                                    imagePath: ImagePath.homeSelected,
                                    width: 24,
                                    height: 24,
                                    color: Colors.white,
                                  ),
                        ...
                        BottomNavigationBarItem(
                          icon: controller.selectedIndex.value == 1
                              ? Container(
                                  ...
                                  child: const ImageHelper(
                                    imagePath: ImagePath.animeSelected,
                                    width: 24,
                                    height: 24,
                                    color: Colors.white,
                                  ),
                        ...
                        BottomNavigationBarItem(
                          icon: controller.selectedIndex.value == 2
                              ? Container(
                                  ...
                                  child: const ImageHelper(
                                    imagePath: ImagePath.exploreSelected,
                                    width: 24,
                                    height: 24,
                                    color: Colors.white,
                                  ),
                        ...
                        BottomNavigationBarItem(
                          icon: controller.selectedIndex.value == 3
                              ? Container(
                                  ...
                                  child: const ImageHelper(
                                    imagePath: ImagePath.newsSelected,
                                    width: 24,
                                    height: 24,
                                    color: Colors.white,
                                  ),
                        ...
                        BottomNavigationBarItem(
                          icon: controller.selectedIndex.value == 4
                              ? Container(
                                  ...
                                  child: const ImageHelper(
                                    imagePath: ImagePath.profileSelected,
                                    width: 24,
                                    height: 24,
                                    color: Colors.white,
                                  ),
